...
//                    sb.append("兴趣点    : " + location.getPoiName() + "\n");
                   ...
                   // sb.append("定位时间: " + Utils.formatUTC(location.getTime(), "yyyy-MM-dd HH:mm:ss") + "\n");
                    ...
                    localAddress=String.valueOf(location.getAddress());
                    stringLatitude=String.valueOf(location.getLongitude());
                    stringLongitude=String.valueOf(location.getLatitude());
...
//                String result = sb.toString();
               ...
               // Toast.makeText(MYActivity.this,"定位失败",Toast.LENGTH_SHORT).show();
            }
        }
    };
